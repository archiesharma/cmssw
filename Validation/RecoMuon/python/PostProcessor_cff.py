...
postProcessorMuonMultiTrack = cms.EDAnalyzer("DQMGenericClient",
    ...
    "fakeratePt075 'Fake rate vs p_{T} Q>75%' num_assoc(recoToSim)_pt_075 num_reco_pT fake",
    "fakeratePt050 'Fake rate vs p_{T} Q>50%' num_assoc(recoToSim)_pt_050 num_reco_pT fake",
    ...
    "effic_vs_hit_Q05 'Efficiency vs n Hits (Quality>0.5)' num_assoc(simToReco)_hit_Q05 num_simul_hit",
    "effic_vs_hit_Q075 'Efficiency vs n Hits (Quality>0.75)' num_assoc(simToReco)_hit_Q075 num_simul_hit",
...
#    "effic_chi2_Q05 'Efficiency vs chi2 (Quality>0.5)' num_assoc(simToReco)_chi2_Q05 num_simul_chi2",
#    "effic_chi2_Q075 'Efficiency vs chi2 (Quality>0.75)' num_assoc(simToReco)_chi2_Q075 num_simul_chi2",
    ...
    "chargeMisIDProb_vs_eta_sim_Q075 'Charge Mis-ID vs. #eta Sim for Q>75%' chargeMisID_vs_etaNum_sim_Q075 chargeMisID_vs_etaDen_sim_Q075",
    "chargeMisIDProb_vs_eta_sim_Q050 'Charge Mis-ID vs. #eta Sim for Q>50%' chargeMisID_vs_etaNum_sim_Q050 chargeMisID_vs_etaDen_sim_Q050",
    ...
    resolution = cms.vstring("cotThetares_vs_eta '#sigma(cot(#theta)) vs #eta' cotThetares_vs_eta",
                             ...
                             "qOverPtres_vs_eta_sim_Q075 '#sigma(q/p_{T}) vs #eta Sim for Q>75%' qOverPtres_vs_eta_sim_Q075", 
                             "qOverPtres_vs_eta_sim_Q050 '#sigma(q/p_{T}) vs #eta Sim for Q>50%' qOverPtres_vs_eta_sim_Q050",
                             "qOverPtresXL_vs_eta_sim_Q075 '#sigma(q/p_{T}) vs #eta Sim for Q>75%' qOverPtresXL_vs_eta_sim_Q075",
                             "qOverPtresXL_vs_eta_sim_Q050 '#sigma(q/p_{T}) vs #eta Sim for Q>50%' qOverPtresXL_vs_eta_sim_Q050",
