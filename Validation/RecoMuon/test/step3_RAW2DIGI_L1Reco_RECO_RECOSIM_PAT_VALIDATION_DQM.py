...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring(
                'file:/tmp/archie/F37B1F94-AD89-DF40-8D40-3EE87E8339A1.root'
                #'file:/afs/cern.ch/work/a/archie/private/EffStudies_HLT/CMSSW_10_4_0_mtd5/src/28244.0_DYToLL_M_50_14TeV+DYToLL_M-50_14TeV_pythia8_2023D39_GenSimHLBeamSpotFull14+DigiFullTrigger_2023D39+RecoFullGlobal_2023D39+HARVESTFullGlobal_2023D39/step3.root'
...
process.FEVTDEBUGHLToutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:/tmp/archie/step3.root'),
...
#process.schedule = cms.Schedule(process.raw2digi_step,process.L1Reco_step,process.reconstruction_step,process.validation_step2,process.dqmoffline_2_step,process.FEVTDEBUGHLToutput_step,process.DQMoutput_step)
